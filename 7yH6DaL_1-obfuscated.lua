    ...
    function(e)
        ...
        if res and res ~= "center" then
            ...
            client.color_log(
                ...
                255,
                100,
                string.format("[resolver] Hit %s in %s for %d damage (%d%% hc)", name, hg, dmg, hc)
            )
        end
    end
)
...
client.set_event_callback(
    ...
    function(e)
        ...
        local hg = hitgroup_names[e.hitgroup] or "body"
        local reason =
            e.reason == "spread" and "spread" or e.reason == "occlusion" and "wall" or
            e.reason == "prediction error" and "prediction" or
            e.reason
