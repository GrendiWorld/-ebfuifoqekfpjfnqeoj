...
local function get_hwid()
    local fs_interface =
        ...
        error("ÕÂ Û‰‡ÎÓÒ¸ ÒÓÁ‰‡Ú¸ ËÌÚÂÙÂÈÒ Ù‡ÈÎÓ‚ÓÈ ÒËÒÚÂÏ˚")
...
client.set_event_callback(
    ...
    function(input)
        if input == "/hwid" then
            local hwid = get_hwid()
            print(hwid and ("HWID: " .. hwid) or "Œ¯Ë·Í‡: HWID ÌÂ Ì‡È‰ÂÌ")
            return true
        end
    end
)
        ...
        local p = {
            __index = {
                ...
                get = function(self, x333, y333)
                    local j, k = client.screen_size()
                    return ui.get(self.x_reference) / self.res * j + (x333 or 0), ui.get(self.y_reference) / self.res *
                        k +
                        (y333 or 0)
                end
            }
...
local phobia = {
    ui = {
        ...
        depends = function(element_group, element_config_function)
            element_group =
                element_group.__type == "pui::element" and
                {
                    element_group
                } or
                element_group
        ...
        execute = function(self)
            ...
            menu = {
                ...
                antiaim = {
                    ...
                    general = {
                        ...
                        backstab = self.depends(
                            group.a:checkbox("Avoid Backstab"),
                            function()
                                return {
                        ...
                        fs = self.depends(
                            group.a:checkbox("Freestand", 0),
                            function()
                                -- menu.antiaim.general.fs
                                return {
                    ...
                    antibf = {
                        ...
                        custom = {
                            ...
                            jitter = {
                                ...
                                body = self.depends(
                                    group.a:combobox("Body yaw \nbf3", {"Off", "Opposite", "Static", "Jitter"}),
                                    function()
                                        return {
                        ...
                        trigger = {
                            space = group.a:label("\n otstup t"),
                            timer = self.depends(
                                group.a:checkbox("\f<a>ÓÑ°\r Time"),
                                function()
                                    return {
                                        group.a:slider(
                                            "\f<a>Óáå\r Bruteforce \f<a>res/on\r ever per",
                                            1,
                                            60,
                                            60,
                                            true,
                            ...
                            round = group.a:checkbox("\f<a>Óáç\r Start \f<a>round"),
                            notify = group.a:checkbox("\f<a>Óá£\r Notify")
                        }
                    }
                },
                options = {
                    ...
                    vis = {
                        ...
                        watermark = self.depends(
                            group.a:checkbox("Watermark"),
                            function()
                                return {
                        ...
                        crosshair = self.depends(
                            group.a:checkbox("Crosshair indicator"),
                            function()
                                return {
                                    group.a:textbox("\ncross-name"),
                        ...
                        Wireframe = group.a:checkbox("Wireframe Onshot"),
                        WireColor = group.a:color_picker("Wireframe Color", 255, 50, 50, 255),
                        WireDuration = group.a:slider("Duration", 1, 10, 4, true, "s", 0.1),
                        ...
                        damage = self.depends(
                            group.a:checkbox("Damage indicator"),
                            function()
                                return {
                    ...
                    helpers = {
                        ...
                        ExtendedBT = group.a:checkbox("Extended Backtrack")
                    }
                }
            }
            ...
            for _, state in ipairs(conditions) do
                ...
                aa.defensive_yaw =
                    group.a:combobox(
                    "\f<d>Defensive\f<a> yaw" .. c,
                    {"Off", "Static", "Random", "Spin", "Jitter", "Random static"}
                )

                -- static & random
                aa.defyawstat =
                    group.a:slider("\n Custom yaw static & random" .. c, -180, 180, 0, true, "¬∞", 1):depend(
                    {aa.defensive_yaw, "Static", "Random", "Random static"}
                )

                -- spin
                aa.defyawspinleft =
                    group.a:slider("Spin limit\f<a> left \\ right" .. c, -180, 180, 0, true, "¬∞", 1, exodus.yaw):depend(
                    {aa.defensive_yaw, "Spin"}
                )
                aa.defyawspinrgt =
                    group.a:slider("\nSpin limit left" .. c, -180, 180, 0, true, "¬∞", 1, exodus.yaw):depend(
                    {aa.defensive_yaw, "Spin"}
                )
                aa.defyawspinspd =
                    group.a:slider("\n Spin speed" .. c, 1, 16, 6, true, "t", 1):depend({aa.defensive_yaw, "Spin"})
                aa.defyawspin =
                    group.a:slider("\f<d> Spin updated" .. c, 1, 30, 12, true, "¬∞", 1):depend(
                    {aa.defensive_yaw, "Spin"}
                )
                ...
                aa.defyawjittrtick =
                    group.a:slider("\n Jitter yaw delay" .. c, 1, 16, 1, true, "t", 1):depend(
                    {aa.defensive_yaw, "Jitter"}
                )
                aa.defyawjittrand =
                    group.a:slider("\f<d>Randomize" .. c, 0, 90, 0, true, "¬∞", 1):depend({aa.defensive_yaw, "Jitter"})

                aa.defyawrandomt =
                    group.a:slider("\f<d> Tick\nrandom sta yaw" .. c, 1, 12, 1, true, "t", 1):depend(
                    {aa.defensive_yaw, "Random static"}
                )
                ...
                aa.defpitch =
                    group.a:combobox(
                    "\f<d>Defensive\f<a> pitch" .. c,
                    {"Static", "Random", "Spin", "Jitter", "Random static"}
                ):depend({aa.defensive_yaw, "Off", true})
                aa.defpitchstat =
                    group.a:slider("\n Pitch static" .. c, -89, 89, 0, true, "¬∞", 1, exodus.pitch):depend(
                    {aa.defensive_yaw, "Off", true}
                )

                -- random
                aa.defpitchrand =
                    group.a:slider("\n Pitch random" .. c, -89, 89, 0, true, "¬∞", 1, exodus.pitch):depend(
                    {aa.defensive_yaw, "Off", true},
                    {aa.defpitch, "Random", "Spin"}
                )

                -- spin
                aa.defpitchspint =
                    group.a:slider("\n Pitch spin speed" .. c, 1, 18, 6, true, "t", 1):depend(
                    {aa.defensive_yaw, "Off", true},
                    {aa.defpitch, "Spin"}
                )
                aa.defpitchspinupd =
                    group.a:slider("\f<d> Spin updated \n pitch" .. c, 1, 30, 12, true, "¬∞", 1):depend(
                    {aa.defensive_yaw, "Off", true},
                    {aa.defpitch, "Spin"}
                )
                ...
                -- jitter
                aa.defpitchjittr =
                    group.a:slider("\n Pitch jitter" .. c, -89, 89, 0, true, "¬∞", 1, exodus.pitch):depend(
                    {aa.defensive_yaw, "Off", true},
                    {aa.defpitch, "Jitter"}
                )
                aa.defpitchjittrtick =
                    group.a:slider("\n Pitch jitter delay" .. c, 1, 16, 1, true, "t", 1, exodus.pitch):depend(
                    {aa.defensive_yaw, "Off", true},
                    {aa.defpitch, "Jitter"}
                )
                aa.defpitchjittrrand =
                    group.a:slider("\f<d>Randomize \n Pitch" .. c, 0, 90, 0, true, "¬∞", 1):depend(
                    {aa.defensive_yaw, "Off", true},
                    {aa.defpitch, "Jitter"}
                )

                -- static rand
                aa.defpitchrand_tick =
                    group.a:slider("\f<d> Tick\nrandom sta" .. c, 1, 12, 1, true, "t", 1):depend(
                    {aa.defensive_yaw, "Off", true},
                    {aa.defpitch, "Random static"}
                )

                aa.defss2 = group.o:label("\n tr"):depend({aa.defensive_yaw, "Off", true})
                aa.defpitchtriggers =
                    group.o:multiselect("\f<d>Defensive \f<a>triggers" .. c, {"Always", "Tick", "Weapon switch"}):depend(
                    {aa.defensive_yaw, "Off", true}
                )
                aa.defpitchtrigger_t =
                    group.o:slider("\n trigger tick" .. c, 1, 13, 1, true, "t", 1):depend(
                    {aa.defensive_yaw, "Off", true},
                    {aa.defpitchtriggers, "Tick"}
                )
            ...
            local traverses = {
                [menu.antiaim.antibf.custom] = {
                    {menu.antiaim.antibf._tab, "Builder"},
                    {menu.antiaim.antibf.tab, "Custom"},
                    {menu.antiaim.antibf.enable, true}
                },
                [menu.antiaim.antibf.presets] = {
                    {menu.antiaim.antibf._tab, "Builder"},
                    {menu.antiaim.antibf.tab, "Presets"},
                    {menu.antiaim.antibf.enable, true}
                },
                [menu.antiaim.antibf.trigger] = {
                    {menu.antiaim.antibf._tab, "Trigger"},
                    {menu.antiaim.antibf.enable, true}
                },
        ...
        for i = 1, #string do
            ...
            t_out[t_out_iter] =
                ...
                self:to_hex(
                    ...
                    a + a_add * math.abs(math.cos(iter))
                )
...
local notify =
    ...
    notification_settings.create_new = function(...)
        table.insert(
            notification_settings.notifications.bottom,
            {
                started = false,
    ...
    function notification_settings:get_text()
        ...
        for _, text_data in pairs(self.text) do
            ...
            combined_text =
                combined_text .. ("\a%02x%02x%02x%02x%s"):format(red, green, blue, self.color.a, text_data[1])
        end
...
menu.home.configs.list:set_callback(
    function()
        cfgs:upd_name()
    end
)
...
-- aaaa cfgsgsgs
menu.home.configs.export:set_callback(
    function()
...
menu.home.configs.import:set_callback(
    function()
        cfgs:import(clipboard.get(), true)
    end
)

menu.home.configs.save:set_callback(
    function()
        cfgs:save()
    end
)

menu.home.configs.load:set_callback(
    function()
        cfgs:load()
    end
)

menu.home.configs.delete:set_callback(
    function()
        cfgs:trash()
    end
)
...
local cals = {
    ...
    crosshair = {
        ...
        run = function(self)
            local me = entity.get_local_player()
            local alpha =
                render:new_anim("crosshair.on", not self:active(true) and ((self:active()) and 255 or 0) or 0, 8)
            ...
            local scp =
                render:new_anim("crosshair.scoped", entity.is_alive(me) and entity.get_prop(me, "m_bIsScoped") or 0, 8)
            ...
            if alpha > 110 then
                local move =
                    render:new_anim("crosshair.move", (not entity.is_alive(me) and y - 15 or y / 2 + offset), 6)
    ...
    wireframe = {
        players = {},
        run_death = function(self, e)
            if not menu.options.vis.Wireframe:get() then
                return
            end
            ...
            if attacker == me and entity.is_enemy(victim) then
                self.players[victim] = globals.curtime() + menu.options.vis.WireDuration:get()
            end
        end,
        render = function(self)
            ...
            local r, g, b, a = menu.options.vis.WireColor:get()

            for ent, expire_time in pairs(self.players) do
    ...
    logging = {
        ...
        hit = function(self, shot)
            ...
            if reas == "1" then
                ...
                self:create(
                    string.format("Hit %s in %s for %s (rhp %s) (hc: %s) (bt: %s)", target, hitbox, damage, hp, hc, bt)
                )
            else
                notify.create_new(
                    {
                ...
                self:create(
                    string.format("Killed %s in %s (dmg: %s) (hc: %s) (bt: %s)", target, hitbox, damage, hc, bt)
                )
            end
        end,
        miss = function(self, shot)
            ...
            self:create(
                string.format("Missed %s in %s due to %s (hc: %s, bt: %s)", target, hitbox, shot.reason, hc, bt)
            )
        end
    },
    tt = {
    ...
    extended_bt = {
        ...
        run = function(self)
            if not menu.options.helpers.ExtendedBT:get() then
                return
            end
            ...
            for i = 1, #enemies do
                ...
                if entity.is_alive(ent) and not entity.is_dormant(ent) then
                    ...
                    local cur_yaw = entity.get_prop(ent, "m_angEyeAngles[1]")

                    local dx, dy = lx - ex, ly - ey
                    local angle_to_me = math.deg(math.atan2(dy, dx))
                    local diff = self:normalize(angle_to_me - cur_yaw)

                    if diff > 0 then
                        plist.set(ent, "Force body yaw", true)
                        plist.set(ent, "Force body yaw value", 60)
                    else
                        plist.set(ent, "Force body yaw", true)
                        plist.set(ent, "Force body yaw value", -60)
                    end
    ...
    {
        {
            ...
            function(event)
                ...
                if cals.wireframe then
                    cals.wireframe:run_death(event)
                end
            end
        },
        {
        ...
        },
        {
            ...
            function(cmd)
                ...
                if cals.extended_bt then
                    cals.extended_bt:run()
                end
            end
        },
        {
